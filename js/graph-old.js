...
// const CAMERA_DISTANCE_MULTIPLIER = 0.82;
...
// function frameGraph(graph, nodes) {
//     const { center, span } = getLayoutBounds(nodes);
//     const distance = Math.max(
//         MIN_CAMERA_DISTANCE,
//         span * CAMERA_DISTANCE_MULTIPLIER
//     );
...
//         .nodeVal(node => node.val * 0.1)
//         .nodeResolution(18)
//         .nodeOpacity(1)
//         .linkOpacity(0.45)
//         .linkColor(link => link.color)
//         .linkWidth(link => {
//             if (link.source.id === "Root") return 0;
//             if (link.source.group === "Category") return 1.5;
//             if (link.source.group === "Subcategory") return 1;
//             return 0.5;
//         })
